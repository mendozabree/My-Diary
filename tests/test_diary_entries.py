...
class DiaryEntryTestCase(unittest.TestCase):
    ...
    def setUp(self):
        self.my_entries = [
            ...
            },
            {
                ...
                'content': 'I am following some flask youtube videos'
                           'from pretty printed.I am going to work along with'
        ...
        self.my_entry = [
            {
                ...
                'content': 'So, pretty printed is very nice channel,'
                           'they explain pretty well. '
                           'Yesterday, i created a simple todo list'
    ...
    def test_API_can_not_make_an_entry_with_missing_key(self):
        ...
        # Add entry with missing key
        response = testing_user.post('/api/v1/entries',
                                     data=json.dumps(self.my_entry[0]),
                                     content_type='application/json')
        self.assertEqual(response.status_code, 400)
    ...
    def test_API_will_fail_to_update_when_content_is_empty(self):
        ...
        # Modify entry with wmpty content
        self.my_entries[0]['content'] = ''
        response = testing_user.put('/api/v1/entries/1',
                                    data=json.dumps(self.my_entries[0]),
                                    content_type='application/json')
        self.assertEqual(response.status_code, 400)
    ...
    def test_API_will_fail_to_update_when_title_is_empty(self):
        ...
        # Modify entry with an empty title
